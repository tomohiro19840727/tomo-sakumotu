...
const App = () => {
  ...
  const cropYieldMultiplier2 = {
    黒大豆: 40428, //1俵 15000円 (35000 + 8100 + 15000) 
    // 肥料代17672円（豆持1号 40kg7590円 + コラーゲン有機30kg4102円 + FK有機40kg5980円 ）

    春麦: 77750, // 1俵 2800円 (35000 + 8100 + (4俵(2800円 + 6000円）✖️ 4 = 35200) + 20000) 
    //数量払い 1俵6000円 面積払い1反20000円
    // 肥料代20550円（有機酸カルシウム60kg3450円 + 有機複合3号100kg17100円）

    秋小麦:102070,  // 1俵 2000円 (35000 + 8100 + (6俵(1800円 + 6000円）✖️ 6 = 48000) + 20000) 
    //数量払い 1俵6000円 面積払い1反20000円
    ...
    新市場ゆめぴりか: 143595,//40000(リノベ) + 20000(道) + 10000(複数) + 15000(省力化) + 7.4俵（単価10000円）
    // 肥料代15405円（有機酸カルシウム30kg1725円 + 有機複合32号270 80kg13680円）

    新市場ななつぼし: 136195,//40000(リノベ) + 20000(道) + 10000(複数) + 15000(省力化) + 7.4俵（単価9000円）
    // 肥料代15405円（有機酸カルシウム30kg1725円 + 有機複合32号270 80kg13680円）
